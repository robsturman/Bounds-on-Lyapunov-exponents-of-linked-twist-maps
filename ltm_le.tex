...
\Psi_{H,k}  \le |\lambda| \le \Phi_{H,k}.
\end{equation}
...
\begin{eqnarray}
\tilde{\Psi}_{H,k} &=& \frac{1}{n_S} \sum_{a_1,b_1,a_2,b_2 = 1}^\infty \tilde{R}(a_2,b_2,a_1,b_1) \log \tilde{\psi}_k (a_2,b_2,a_1,b_1)\\
\tilde{\Phi}_{H,k} &=& \frac{1}{n_S} \sum_{a_1,b_1,a_2,b_2 = 1}^\infty \tilde{R}(a_2,b_2,a_1,b_1) \log \tilde{\phi}_k (a_2,b_2,a_1,b_1).
\end{eqnarray}
...
$\Psi_{H,k}$ for each of the $L_1$ (red), $L_2$ (blue), $L_{\infty}$ (green) norms. The numerically calculated value for $\lambda$, from $10^5$ iterates of the standard orthonormalisation scheme, is shown as a solid black line. Upper bounds are shown as solid lines, and lower as dashed lines. 
